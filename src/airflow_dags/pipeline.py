...
def launch_and_manage_api_request(api_url: str, body: dict, description: str) -> dict:
    ...
    try:
        ...
        msg = (f'Connection error. Check that the api to {description} is running or that'
               f' the host and port are specified correctly. Error description: {err}.')
        raise ConnectionError(msg)
    except Exception as err:
        msg = (f'Unknown error when request the api to {description}. Error: '
...
with DAG('Max_char_per_line_ML_pipeline',
    ...
    def get_data(*op_args):
        ...
        return launch_and_manage_api_request(api_url=URL_GET_DATA_API, body=body,
    ...
    def validate_data(*op_args):
        ...
        return launch_and_manage_api_request(api_url=URL_VALIDATE_DATA_API, body=body,
    ...
    def version_data(*op_args, **context):
        ...
        return launch_and_manage_api_request(api_url=URL_VERSION_DATA_API, body=body,
    ...
    def fit_data_transformer(*op_args, **context):
        ...
        return launch_and_manage_api_request(api_url=URL_FIT_DATA_TRANSFORMER_API,
    ...
    def train_model(*op_args, **context):
        ...
        return launch_and_manage_api_request(api_url=URL_TRAIN_MODEL_API, body=body,
    ...
    def evaluate_model(*op_args, **context):
        ...
        return launch_and_manage_api_request(api_url=URL_EVALUATE_MODEL_API, body=body,
                                             description='evaluate the model')
    MODEL_EVALUATION_ARGS = [
        RAW_DATA_PATH, DATASET_NAME, SIZE_TEST_SPLIT, TEST_SPLIT_SEED
    ]
    model_evaluation = PythonOperator(task_id='model_evaluation',
    ...
    def validate_model(*op_args, **context):
        ...
        return launch_and_manage_api_request(api_url=URL_VALIDATE_MODEL_API, body=body,
...
(run_creation >> data_ingestion >> data_validation >> data_versioning
    >> preprocessing_fitter >> model_training >> model_evaluation >> model_validation)
